...
import {
  ...
  function signUpAction(prevFormState, formData) {
    ...
    if (!isNotEmpty(password) || !hasMinLength(password, 6)) {
      errors.push("You must provide a password with atleast six ");
    }
...
export default function Signup() {
  ...
  const [formState, formAction, pending] = useActionState(signUpAction, {
    errors: null,
    enteredValues : {}
  }); // useAction takes an action on form submission and with that an initial state snapshot where errors are set to null
  return (
